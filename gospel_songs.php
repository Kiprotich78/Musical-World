...
<head>
	<title>Musical World | Gospel Songs</title>
		...
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
                ...
                <li class="nav-item">
                    ...
                    <p style="color:blue;">| Gospel Songs |</p>
                </li>
	...
	<?php
			...
			if(mysqli_num_rows($result)>0){
				while($row = mysqli_fetch_array($result)){
					...
					echo "
							<div class='col-md-3'>
								<form method='post' action='gospel_songs.php'>
									<div class='card-deck'>
										<div class='card-img'>
											<img src='songs/gospel_songs/img/$song_image' style='width:350px;height:250px' alt=''>
										</div>
										<div class='card-desc'>
											<h3>$song_name | $singer_name</h3>
											<h3>movie - $movie_name</h3>
											<audio class='embed-responsive-item' controls='' preload='none'> <source src='songs/gospel_songs/$audio_file' type='audio/mp3'></audio><br>
